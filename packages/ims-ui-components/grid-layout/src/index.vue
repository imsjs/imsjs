...
import { ImsGridLayoutProps } from "@imsjs/ims-ui-types";

import draggable from "vuedraggable";

import { nanoid } from "nanoid";

const { prefixCls } = useStyle("grid-layout");
const COMPONENT_NAME = "ImsGridLayout";
...
defineProps<ImsGridLayoutProps>();
...
@prefix-cls: ~"@{namespace}-grid-layout";
